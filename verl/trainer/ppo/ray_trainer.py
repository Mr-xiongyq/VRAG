        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with _timer('step', timing_raw):
                    ...
                    # Special design for RAG dataset for reward func
                    print("Debug: batch.non_tensor_batch keys =>", batch.non_tensor_batch.keys(), flush=True)
                    print("Debug: example extra_info =>", batch.non_tensor_batch.get('extra_info', [None])[0], flush=True)
                    ...
                    for extra_info in batch.non_tensor_batch['extra_info']:
                        ...
                        if file_name is None or reference_page is None:
                            print(f"Warning: Missing keys in extra_info: {extra_info}", flush=True)
